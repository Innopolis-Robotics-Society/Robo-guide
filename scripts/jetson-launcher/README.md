...
2. **Меню оператора** (долгое нажатие 2 с в правый верхний угол → PIN или RFID): выбор текущего
...
- Долгое нажатие 2 с в правый верхний угол → окно входа (ожидание RFID и PIN-клавиатура).
