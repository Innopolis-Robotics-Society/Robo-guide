...
def test_grammar_root_has_tool_then_args_without_think() -> None:
    """tool первым: имя инструмента фиксируется до args, без ReAct-think."""
...
def test_grammar_has_no_think_field() -> None:
    grammar = build_tool_call_grammar(["say"])
